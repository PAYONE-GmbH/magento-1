 ...
 */
class Payone_Core_Block_Adminhtml_System_Config_Form_Field_CcTranslationPlaceholders
    extends Payone_Core_Block_Adminhtml_System_Config_Form_Field_Abstract
{
    ...
    protected function _renderCellTemplate($columnName)
    {
        if ($columnName == 'translation_type') {
            ...
            $modelConfigCode = $this->getFactory()->getModelSystemConfigTranslationPlaceholders();
