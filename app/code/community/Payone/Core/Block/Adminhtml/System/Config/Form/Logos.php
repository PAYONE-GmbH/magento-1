 ...
 * @link            http://www.noovias.com
 */
class Payone_Core_Block_Adminhtml_System_Config_Form_Logos extends Mage_Adminhtml_Block_Abstract
{
     ...
     *
     * @return Payone_Core_Block_Adminhtml_System_Config_Form_Logos
     */
    ...
    {
        $url = $this->getUrl('adminhtml/payonecore_system_config_logos', array());
        return $url;
    }
}
