...
class Payone_Core_Block_Mastercard_Masterpass_Review_Billing extends Mage_Core_Block_Template
{
    /** @var int */
    protected $quoteId;
    /** @var string */
    ...
    public function init()
    {
        ...
        if (!empty($quote->getCustomerDob())) {
            $this->setBirthday($quote->getCustomerDob());
        }
    }
    ...
    public function setBirthday($birthday)
    {
        ...
        $this->birthday = $dob->format("d-m-Y");
