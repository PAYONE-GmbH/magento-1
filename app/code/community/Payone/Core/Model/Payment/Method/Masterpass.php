...
class Payone_Core_Model_Payment_Method_Masterpass extends Payone_Core_Model_Payment_Method_Abstract
{
    /**
     * @var string
     */
    protected $methodType = Payone_Core_Model_System_Config_PaymentMethodType::MASTERPASS;

    /**
     * @var string
     */
    protected $_code = Payone_Core_Model_System_Config_PaymentMethodCode::MASTERPASS;
