 ...
 */
class Payone_Core_Model_Payment_Method_OnlineBankTransferTrustly extends Payone_Core_Model_Payment_Method_Abstract
{
    protected $methodType = Payone_Core_Model_System_Config_PaymentMethodType::ONLINEBANKTRANSFERTRUSTLY;
    protected $_code = Payone_Core_Model_System_Config_PaymentMethodCode::ONLINEBANKTRANSFERTRUSTLY;
    protected $_formBlockType = 'payone_core/payment_method_form_onlineBankTransferTrustly';
