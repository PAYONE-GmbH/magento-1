...
class Payone_Core_Model_Payment_Method_RatepayDirectDebit extends Payone_Core_Model_Payment_Method_Abstract
{
    protected $_canUseForMultishipping = true;

    protected $methodType = Payone_Core_Model_System_Config_PaymentMethodType::RATEPAYDIRECTDEBIT;

    protected $_code = Payone_Core_Model_System_Config_PaymentMethodCode::RATEPAYDIRECTDEBIT;

    protected $_formBlockType = 'payone_core/payment_method_form_ratepayDirectDebit';
    protected $_infoBlockType = 'payone_core/payment_method_info_ratepayDirectDebit';
